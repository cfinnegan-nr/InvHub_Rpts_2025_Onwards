...
class TestAutomationAnalyzer:
        ...
        fig = go.Figure(data=[go.Table(
            ...
            cells=dict(values=[
                ...
                fill_color=[
                    ...
                    'lightblue',
                    'white',
                    self.consolidated_df['status'].apply(lambda x: 'lightgreen' if x == 'Acceptable' 
    ...
    def save_epic_summary_table(self, output_path: str = 'epic_summary_table_ChatGPT_1.png'):
    ...
    def save_epic_summary_to_excel(self, output_excel_path: str = 'epic_summary_ChatGPT_1.xlsx'):
        # Add totals row
